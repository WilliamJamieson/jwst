...
class RejectionConvergenceError(RuntimeError):
    """
    Raised when an iterative rejection fails to converge
    """
...
class ChiSqOutlierRejectionFitter:
    ...
    def __call__(self, model, x, y, weights=None, **kwargs):
        ...
        for _ in range(1000 * nparams):
            ...
            raise RejectionConvergenceError("Bad fit, method should have converged")

        return new_model, new_weights, chi
